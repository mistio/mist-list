            ...
            if (_this.rest) {
              ...
              if (opts.sortOrders && opts.sortOrders.length)
                url +=
                  'order=' +
                  encodeURIComponent(
                    opts.sortOrders.map(function (b) {
                ...
                if (xhr.readyState === 4 && xhr.status === 200) {
                  ...
                  if (items && items.length) {
                    ...
                    if (_this.timeseries && items.length == opts.pageSize) {
                      _this.set(
                        'stop',
                        items[items.length - 1][_this.primaryFieldName]
                      );
                    } else if (
                      _this.timeseries &&
              ...
              if (
                this._filters &&
                this._checkPaths(this._filters, 'filtering', items)
              ) {
              ...
              if (
                ...
                this._checkPaths(this._sorters, 'sorting', items)
              ) {
